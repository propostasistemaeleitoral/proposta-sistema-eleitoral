...
for percentagem_minima_circulo_nacional, pasta_output_1 in lista_percentagem_minima_circulo_nacional:
...
#########################################################################################################################################################
            ...
            ficheiro_output = f"Limite_{pasta_output_1}_eleicao_{ano}_cenario_{cenario}_com_{numero_cirulos_uninominais}_uninominais_e_{numero_mandatos_circulo_nacional}_simulado_em_{momento_agora.strftime('%Y')}_{momento_agora.strftime('%m')}_{momento_agora.strftime('%d')}_{momento_agora.strftime('%H')}_{momento_agora.strftime('%M')}_{momento_agora.strftime('%S')}.xlsx"

#########################################################################################################################################################

            # Para criar um ficheiro excel com os df's'
          
            with pd.ExcelWriter(f"../output/{pasta_output_1}/{ano}/{ficheiro_output}", engine='openpyxl') as writer:
...
#########################################################################################################################################################
                ...
                df_votos_totais_por_tipo_circulo_com_europa_e_fora_europa.index.name = "Votos, por partido e círculo (círculos uninominais agregados), filtrado pela percent. limite no Nacional, (TN e TE)"
                ...
                df_votos_totais_por_tipo_circulo_com_europa_e_fora_europa_com_limiar.index.name = "Votos, por partido e círculo (círculos uninominais agregados) no SP (TN e TE)"
...
#########################################################################################################################################################
            ...
            print(f"Ficheiro {ficheiro_output} guardado na pasta output/{pasta_output_1}/{ano}")
